...
namespace dune_library.Map_Resoures {
  internal class With_Spice(int sector, Territory territory, int spice_capacity, IDictionary<Faction, ISet<Section>> map_presences) : Section(sector, territory, map_presences) {
