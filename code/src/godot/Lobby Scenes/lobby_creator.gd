...
func _on_easy_difficulty_button_pressed():
	...
	$MarginContainer/HBoxContainer/VBoxContainer/HBoxContainer/Easy_Difficulty_Button.modulate = Color(1, 100/255.0, 0)
...
func _on_normal_difficulty_button_pressed():
	...
	$MarginContainer/HBoxContainer/VBoxContainer/HBoxContainer/Easy_Difficulty_Button.modulate = Color(1, 1, 1)
	$MarginContainer/HBoxContainer/VBoxContainer/HBoxContainer/Hard_Difficulty_Button.modulate = Color(1, 1, 1)
...
func _on_create_button_pressed():
	...
	get_tree().change_scene_to_file("res://Lobby Scenes/lobby_host.tscn")
