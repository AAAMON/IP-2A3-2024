...
class BotManager:
    ...
    def get_move(self, bot_name, game_state):
        ...
        alowed_bots = ["bg-easy", "fremen-easy","atreides-easy","spacingGuild-easy","emperor-med","spacingGuild-med","beneGesserit-med", "bot-med", "fremen-med","harkonnen-med","atreides-med"]
